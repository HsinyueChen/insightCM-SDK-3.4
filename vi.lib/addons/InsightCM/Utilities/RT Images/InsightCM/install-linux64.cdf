...
<DEFINITION>
  <SOFTPKG NAME="{DA5M1P2A-6R6O-4A27-B289-A8D884DABECJ}" VERSION="3.4.0" TYPE="VISIBLE">
    ...
    <IMPLEMENTATION>
      ...
      <CODEBASE FILENAME="Linux/x64/libbrsrp.so.1.0.0" TARGET="/usr/local/natinst/lib/libbrsrp.so.1.0.0" />
      <CODEBASE FILENAME="Linux/x64/libbrniauth.so.1.0.0" TARGET="/usr/local/natinst/lib/libbrniauth.so.1.0.0" />
